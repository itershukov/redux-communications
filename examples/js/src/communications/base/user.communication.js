...
import { EUserActionsTypes } from './user.types';

const namespace = 'user';

const userCollectionConfig = {
  mapSuccess: userResponseFormatter, // Reformat response from BE
  preRequestDataMapper: buildCollectionPreRequestDataMapper() // Prevent clear branch when request started
};
...
export const userCommunication = buildCommunication(strategy);
